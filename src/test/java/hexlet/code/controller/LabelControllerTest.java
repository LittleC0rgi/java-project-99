...
import hexlet.code.util.AuthenticationTestUtils;
import hexlet.code.util.UserGenerator;
...
import static hexlet.code.util.AuthenticationTestUtils.DEFAULT_PASSWORD;
